...
import { defineProjectSpec } from '../../service/internal/defineProjectSpec.js';
...
} from './resources/dashboardApp.js';
      ...
      switch (name) {
        case 'brain_dashboard': {
          ...
          return {
            ...
            _meta: {
              ui: { resourceUri: getDashboardResourceUri() },
              'openai/outputTemplate': getDashboardResourceUri(),
